...
class ResNet(nn.Module):
    ...
    def forward(self, x, space=[None] * 20):
        ...
        out = relu(self.bn1(self.conv1(x.view(bsz, 3, 32, 32), space=space[0])))
...
def main(args):
    ...
    for k,ncla in taskcla:
        ...
        torch.save(model, args.savename + '/' + str_time + '/model_random_' + str(args.seed) + '_task_' + str(
            task_id) + '.pkl')
...
if __name__ == "__main__":
    # Training parameters
    parser = argparse.ArgumentParser(description='FIVE with ROGO')
